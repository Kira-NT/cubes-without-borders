        ...
        return YetAnotherConfigLib.createBuilder()
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(Option.<Boolean>createBuilder()
                    .name(Components.translatable(modId + ".options.useDelayedFullscreen"))
                    .description(OptionDescription.of(Components.translatable(modId + ".options.useDelayedFullscreen.tooltip")))
                    .binding(true, config::getUseDelayedFullscreen, config::setUseDelayedFullscreen)
